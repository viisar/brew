...
# randomly create array, not guaranteed to have columns summing to one
example1 = np.random.random((3,3))

example2 = {
    'data': np.array([  [0.04996443, 0.24576966, 0.86503572],
                        [0.46393445, 0.23593924, 0.03325572],
                        [0.48610112, 0.51829110, 0.10170856]    ]),
    'max': 0,
    'min': 2,
    'mean': 0,
    'median': 2,
...
example3 = {
    'data': np.array([  [0.57008830, 0.80026528, 0.18533205],
...
example4 = {
    'data': np.array([  [0.07232759, 0.37269885, 0.67088035],
...
example5 = {
    'data': np.array([  [0.51447044, 0.43834843, 0.2379288],
...
class TestMax():
    ...
    def test_(self):
        assert max_rule(example5['data']) == example5['max']
...
class TestMin():
    ...
    def test_(self):
        assert min_rule(example5['data']) == example5['min']
...
class TestMean():
    ...
    def test_(self):
        assert mean_rule(example5['data']) == example5['mean']
...
class TestMedian():
    ...
    def test_(self):
        assert median_rule(example5['data']) == example5['median']
...
class TestMajorityVote():
    ...
    def test_example7(self):
        assert majority_vote_rule(example8['data']) == example8['majority_vote']
